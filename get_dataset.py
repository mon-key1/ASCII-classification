...
fonts_folder = 'fonts-otf'
output_folder = 'data/data_f/train'
    ...
    if font_file.endswith('.otf') or font_file.endswith('.ttf'):
        ...
        for text in texts:
            try:
                ...
                output_filename = f"{text}_{os.path.splitext(font_file)[0]}_original.png"
                ...
                for i in range(10):
                    ...
                    output_filename = f"{text}_{os.path.splitext(font_file)[0]}_variation_{i+1}.png"
                    output_path = os.path.join(output_folder, output_filename)
                    transformed_image.save(output_path)
                    print(f"Created image: {output_path}")

            except Exception as e:
                print(f"Error creating image for text {text} with font {font_file}: {e}")
